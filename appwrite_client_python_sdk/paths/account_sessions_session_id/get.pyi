...
class GetSessionRaw(BaseApi):
    ...
    async def aget_session(
        ...
        **kwargs,
        ...
        args = self._get_session_mapped_args(
            session_id=session_id,
        )
        return await self._aget_session_oapg(
...
class GetSession(BaseApi):
    ...
    async def aget_session(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_session(
            session_id=session_id,
            **kwargs,
        )
        if validate:
    ...
    def get_session(
        ...
        raw_response = self.raw.get_session(
            session_id=session_id,
        )
        if validate:
            return SessionPydantic(**raw_response.body)
