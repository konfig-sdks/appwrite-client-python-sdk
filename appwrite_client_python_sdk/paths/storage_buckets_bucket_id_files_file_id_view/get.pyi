...
class BaseApi(api_client.Api):
    ...
    def _get_file_for_view_mapped_args(
        self,
        bucket_id: str,
        file_id: str,
    ...
    async def _aget_file_for_view_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/storage/buckets/{bucketId}/files/{fileId}/view',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetFileForViewRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_file_for_view(
        self,
        bucket_id: str,
        file_id: str,
        **kwargs,
        ...
        args = self._get_file_for_view_mapped_args(
            bucket_id=bucket_id,
            file_id=file_id,
        )
        return await self._aget_file_for_view_oapg(
    ...
    def get_file_for_view(
        ...
        return self._get_file_for_view_oapg(
            path_params=args.path,
        )

class GetFileForView(BaseApi):
    ...
    async def aget_file_for_view(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_file_for_view(
            bucket_id=bucket_id,
            file_id=file_id,
            **kwargs,
        )
    ...
    def get_file_for_view(
        ...
        raw_response = self.raw.get_file_for_view(
            bucket_id=bucket_id,
            file_id=file_id,
        )
