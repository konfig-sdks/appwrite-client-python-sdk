...
class BaseApi(api_client.Api):
    ...
    def _get_country_flag_by_code_mapped_args(
        self,
        code: str,
    ...
    async def _aget_country_flag_by_code_oapg(
        self,
    ...
    def _get_country_flag_by_code_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetCountryFlagByCodeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_country_flag_by_code(
        self,
        code: str,
        width: typing.Optional[int] = None,
        height: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_country_flag_by_code_mapped_args(
            code=code,
            width=width,
            height=height,
            quality=quality,
        )
        return await self._aget_country_flag_by_code_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_country_flag_by_code(
        self,
        code: str,
        width: typing.Optional[int] = None,
        height: typing.Optional[int] = None,
        ...
        return self._get_country_flag_by_code_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetCountryFlagByCode(BaseApi):
    ...
    async def aget_country_flag_by_code(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_country_flag_by_code(
            code=code,
            width=width,
            height=height,
            quality=quality,
    ...
    def get_country_flag_by_code(
        ...
        raw_response = self.raw.get_country_flag_by_code(
            code=code,
            width=width,
            height=height,
            quality=quality,
