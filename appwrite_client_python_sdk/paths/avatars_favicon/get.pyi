...
class GetFaviconRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_favicon(
        self,
        url: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_favicon_mapped_args(
            url=url,
        )
        return await self._aget_favicon_oapg(
    ...
    def get_favicon(
        ...
        return self._get_favicon_oapg(
            query_params=args.query,
        )

class GetFavicon(BaseApi):
    ...
    async def aget_favicon(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_favicon(
            url=url,
            **kwargs,
        )
    ...
    def get_favicon(
        ...
        raw_response = self.raw.get_favicon(
            url=url,
        )
