...
class BaseApi(api_client.Api):
    ...
    def _create_phone_verification_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _acreate_phone_verification_oapg(
        self,
    ...
    def _create_phone_verification_oapg(
        self,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
...
class CreatePhoneVerificationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_phone_verification(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor201Async,
        ...
        args = self._create_phone_verification_mapped_args(
        )
        return await self._acreate_phone_verification_oapg(
            **kwargs,
        )
    ...
    def create_phone_verification(
        ...
        return self._create_phone_verification_oapg(
        )

class CreatePhoneVerification(BaseApi):
    ...
    async def acreate_phone_verification(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_phone_verification(
            **kwargs,
        )
        if validate:
    ...
    def create_phone_verification(
        ...
        raw_response = self.raw.create_phone_verification(
        )
        if validate:
            return TokenPydantic(**raw_response.body)
        return api_client.construct_model_instance(TokenPydantic, raw_response.body)
