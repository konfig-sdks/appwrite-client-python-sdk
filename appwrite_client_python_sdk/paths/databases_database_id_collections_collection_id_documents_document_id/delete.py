...
class BaseApi(api_client.Api):
    ...
    def _delete_document_by_id_mapped_args(
        self,
        database_id: str,
        collection_id: str,
        document_id: str,
    ...
    async def _adelete_document_by_id_oapg(
        self,
    ...
    def _delete_document_by_id_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteDocumentByIdRaw(BaseApi):
    ...
    async def adelete_document_by_id(
        ...
        **kwargs,
        ...
        args = self._delete_document_by_id_mapped_args(
            database_id=database_id,
            collection_id=collection_id,
            document_id=document_id,
        )
        return await self._adelete_document_by_id_oapg(
    ...
    def delete_document_by_id(
        ...
        return self._delete_document_by_id_oapg(
            path_params=args.path,
        )

class DeleteDocumentById(BaseApi):
    ...
    async def adelete_document_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_document_by_id(
            database_id=database_id,
            collection_id=collection_id,
            document_id=document_id,
            **kwargs,
    ...
    def delete_document_by_id(
        ...
        raw_response = self.raw.delete_document_by_id(
            database_id=database_id,
            collection_id=collection_id,
            document_id=document_id,
        )
