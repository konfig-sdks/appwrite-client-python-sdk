...
class BaseApi(api_client.Api):
    ...
    def _generate_qr_code_image_mapped_args(
        self,
        text: str,
    ...
    async def _agenerate_qr_code_image_oapg(
        self,
    ...
    def _generate_qr_code_image_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GenerateQrCodeImageRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def agenerate_qr_code_image(
        self,
        text: str,
        size: typing.Optional[int] = None,
        margin: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._generate_qr_code_image_mapped_args(
            text=text,
            size=size,
            margin=margin,
            download=download,
        )
        return await self._agenerate_qr_code_image_oapg(
    ...
    def generate_qr_code_image(
        ...
        return self._generate_qr_code_image_oapg(
            query_params=args.query,
        )

class GenerateQrCodeImage(BaseApi):
    ...
    async def agenerate_qr_code_image(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.agenerate_qr_code_image(
            text=text,
            size=size,
            margin=margin,
            download=download,
    ...
    def generate_qr_code_image(
        ...
        raw_response = self.raw.generate_qr_code_image(
            text=text,
            size=size,
            margin=margin,
            download=download,
