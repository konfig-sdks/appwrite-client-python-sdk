...
class BaseApi(api_client.Api):
    ...
    def _get_browser_icon_by_code_mapped_args(
        self,
        code: str,
    ...
    async def _aget_browser_icon_by_code_oapg(
        self,
    ...
    def _get_browser_icon_by_code_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetBrowserIconByCodeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_browser_icon_by_code(
        self,
        code: str,
        width: typing.Optional[int] = None,
        height: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_browser_icon_by_code_mapped_args(
            code=code,
            width=width,
            height=height,
            quality=quality,
        )
        return await self._aget_browser_icon_by_code_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_browser_icon_by_code(
        self,
        code: str,
        width: typing.Optional[int] = None,
        height: typing.Optional[int] = None,
        ...
        return self._get_browser_icon_by_code_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetBrowserIconByCode(BaseApi):
    ...
    async def aget_browser_icon_by_code(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_browser_icon_by_code(
            code=code,
            width=width,
            height=height,
            quality=quality,
    ...
    def get_browser_icon_by_code(
        ...
        raw_response = self.raw.get_browser_icon_by_code(
            code=code,
            width=width,
            height=height,
            quality=quality,
