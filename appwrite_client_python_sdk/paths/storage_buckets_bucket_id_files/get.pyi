...
from appwrite_client_python_sdk.model.file_list import FileList as FileListSchema

from appwrite_client_python_sdk.type.file_list import FileList

from ...api_client import Dictionary
from appwrite_client_python_sdk.pydantic.file_list import FileList as FileListPydantic
...
SchemaFor200ResponseBodyApplicationJson = FileListSchema
...
class ListFilesRaw(BaseApi):
    ...
    async def alist_files(
        ...
        **kwargs,
        ...
        args = self._list_files_mapped_args(
            bucket_id=bucket_id,
            queries=queries,
            search=search,
        )
        return await self._alist_files_oapg(
    ...
    def list_files(
        ...
        return self._list_files_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListFiles(BaseApi):
    ...
    async def alist_files(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_files(
            bucket_id=bucket_id,
            queries=queries,
            search=search,
            **kwargs,
        ...
        if validate:
            return FileListPydantic(**raw_response.body)
        return api_client.construct_model_instance(FileListPydantic, raw_response.body)
    ...
    def list_files(
        ...
        raw_response = self.raw.list_files(
            bucket_id=bucket_id,
            queries=queries,
            search=search,
        )
