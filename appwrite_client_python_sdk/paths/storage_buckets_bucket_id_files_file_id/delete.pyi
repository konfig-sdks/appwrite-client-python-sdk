...
class BaseApi(api_client.Api):
    ...
    def _delete_file_by_id_mapped_args(
        self,
        bucket_id: str,
        file_id: str,
    ...
    async def _adelete_file_by_id_oapg(
        self,
...
class DeleteFileByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_file_by_id(
        self,
        bucket_id: str,
        file_id: str,
        **kwargs,
        ...
        args = self._delete_file_by_id_mapped_args(
            bucket_id=bucket_id,
            file_id=file_id,
        )
        return await self._adelete_file_by_id_oapg(
    ...
    def delete_file_by_id(
        ...
        return self._delete_file_by_id_oapg(
            path_params=args.path,
        )

class DeleteFileById(BaseApi):
    ...
    async def adelete_file_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_file_by_id(
            bucket_id=bucket_id,
            file_id=file_id,
            **kwargs,
        )
    ...
    def delete_file_by_id(
        ...
        raw_response = self.raw.delete_file_by_id(
            bucket_id=bucket_id,
            file_id=file_id,
        )
