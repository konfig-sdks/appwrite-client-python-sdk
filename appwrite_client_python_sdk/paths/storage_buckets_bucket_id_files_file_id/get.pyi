...
class BaseApi(api_client.Api):
    ...
    def _get_file_by_id_mapped_args(
        self,
        bucket_id: str,
        file_id: str,
    ...
    async def _aget_file_by_id_oapg(
        self,
...
class GetFileByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_file_by_id(
        self,
        bucket_id: str,
        file_id: str,
        **kwargs,
        ...
        args = self._get_file_by_id_mapped_args(
            bucket_id=bucket_id,
            file_id=file_id,
        )
        return await self._aget_file_by_id_oapg(
    ...
    def get_file_by_id(
        ...
        return self._get_file_by_id_oapg(
            path_params=args.path,
        )

class GetFileById(BaseApi):
    ...
    async def aget_file_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_file_by_id(
            bucket_id=bucket_id,
            file_id=file_id,
            **kwargs,
        )
    ...
    def get_file_by_id(
        ...
        raw_response = self.raw.get_file_by_id(
            bucket_id=bucket_id,
            file_id=file_id,
        )
        if validate:
