...
class BaseApi(api_client.Api):
    ...
    def _create_o_auth2_session_mapped_args(
        self,
        provider: str,
    ...
    async def _acreate_o_auth2_session_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/account/sessions/oauth2/{provider}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _create_o_auth2_session_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CreateOAuth2SessionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_o_auth2_session(
        self,
        provider: str,
        success: typing.Optional[str] = None,
        failure: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._create_o_auth2_session_mapped_args(
            provider=provider,
            success=success,
            failure=failure,
            scopes=scopes,
        )
        return await self._acreate_o_auth2_session_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def create_o_auth2_session(
        self,
        provider: str,
        success: typing.Optional[str] = None,
        failure: typing.Optional[str] = None,
        ...
        return self._create_o_auth2_session_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class CreateOAuth2Session(BaseApi):
    ...
    async def acreate_o_auth2_session(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_o_auth2_session(
            provider=provider,
            success=success,
            failure=failure,
            scopes=scopes,
    ...
    def create_o_auth2_session(
        ...
        raw_response = self.raw.create_o_auth2_session(
            provider=provider,
            success=success,
            failure=failure,
            scopes=scopes,
