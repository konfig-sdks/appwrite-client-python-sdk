...
class ExecutionList(
        ...
        class properties:
            ...
            class executions(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Execution']:
                        return Execution
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['Execution'], typing.List['Execution']],
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["total", "executions", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["total", "executions", ], str]):
