...
class CurrencyList(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["total", "currencies", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["total", "currencies", ], str]):
