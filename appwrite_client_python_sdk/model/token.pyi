...
class Token(
    ...
    phrase: MetaOapg.properties.phrase
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["$id", "$createdAt", "userId", "secret", "expire", "phrase", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["phrase"]) -> MetaOapg.properties.phrase: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["$id", "$createdAt", "userId", "secret", "expire", "phrase", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        phrase: typing.Union[MetaOapg.properties.phrase, str, ],
