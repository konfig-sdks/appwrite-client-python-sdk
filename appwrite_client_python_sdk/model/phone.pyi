...
class Phone(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["code", "countryCode", "countryName", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["code", "countryCode", "countryName", ], str]):
