...
class MessagingAddNewSubscriberRequest(
    schemas.DictSchema
):
    """
    ...
    subscriberId: MetaOapg.properties.subscriberId
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["subscriberId", "targetId", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["subscriberId"]) -> MetaOapg.properties.subscriberId: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["subscriberId", "targetId", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        subscriberId: typing.Union[MetaOapg.properties.subscriberId, str, ],
