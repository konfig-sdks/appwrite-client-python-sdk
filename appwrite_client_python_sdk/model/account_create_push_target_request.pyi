...
class AccountCreatePushTargetRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["targetId", "identifier", "providerId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["targetId", "identifier", "providerId", ], str]):
