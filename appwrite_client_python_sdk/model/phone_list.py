...
class PhoneList(
    ...
    phones: MetaOapg.properties.phones
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["total", "phones", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["phones"]) -> MetaOapg.properties.phones: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["total", "phones", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        phones: typing.Union[MetaOapg.properties.phones, list, tuple, ],
        _configuration: typing.Optional[schemas.Configuration] = None,
