...
from appwrite_client_python_sdk.pydantic.teams_create_membership_request_roles import TeamsCreateMembershipRequestRoles

class TeamsCreateMembershipRequest(BaseModel):
    roles: TeamsCreateMembershipRequestRoles = Field(alias='roles')
